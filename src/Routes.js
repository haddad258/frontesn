...
const ListProf = lazy(()=>import('./ManagementProf/ListProf'))
const ListSubject = lazy(()=>import('./MangementSubject/ListSubject'))
const AddSubject = lazy(()=>import('./MangementSubject/FormAdd'))
const ListStudent = lazy(()=>import('./ManagementStudent/ListStudent'))
const AddProf = lazy(()=>import('./ManagementProf/FormAdd'))
const ListClasses = lazy(()=>import('./ManagementClasses/ListClasses'))
              ...
              <LeftSidebar>
                <Switch location={location} key={location.pathname}>
                  <motion.div
                    ...
                    <Route path="/ListClasses" component={ListClasses} />
